...
export async function POST(request: Request) {
  try {
    ...
    const stepConfigs = [
      ...
      { name: "Tese temática (Sonnet)", assign: USERS.GUSTAVO },
      { name: "Questões pendentes", assign: USERS.CASSIO },
      { name: "Tese jurídica (Opus)", assign: USERS.GUSTAVO },
      { name: "Viabilidade (Claude)", assign: USERS.CASSIO },
      { name: "Proposta de honorários", assign: USERS.AMABILLIN },
      { name: "Contratação", assign: USERS.CASSIO },
      { name: "Elaborar contrato, procuração e declaração", assign: USERS.AMABILLIN },
      { name: "Documentação complementar", assign: USERS.GUSTAVO },
      { name: "Elaborar petição (Claude)", assign: USERS.GUSTAVO },
      { name: "Auditoria (GPT)", assign: USERS.GUSTAVO },
      { name: "Formatação", assign: USERS.AMABILLIN },
