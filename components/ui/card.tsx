...
>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn(
      "group relative bg-white rounded-md shadow-sm border border-brand-olive overflow-hidden",
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <h3
    ref={ref}
    className={cn(
      "font-serif text-xl font-semibold leading-none tracking-tight text-brand",
      className
    )}
    {...props}
  />
