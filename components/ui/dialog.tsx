  ...
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ...
      className={cn(
        ...
        "border border-slate-200/50 bg-white/95 backdrop-blur-lg p-8 shadow-2xl duration-300 rounded-2xl",
    ...
    >
      {children}
      <DialogPrimitive.Close className="absolute right-6 top-6 rounded-lg opacity-70 ring-offset-background transition-all duration-200 hover:opacity-100 hover:bg-slate-100 hover:scale-110 focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 disabled:pointer-events-none data-[state=open]:bg-accent data-[state=open]:text-muted-foreground p-2">
        <X className="h-5 w-5" />
