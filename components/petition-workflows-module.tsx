...
export function PetitionWorkflowsModule() {
  ...
  { title: "Tese Jurídica (Geral)", text: "**Aciona com:** `/tese-juridica casos/[CASO]/`\n\n**Use quando:** os fatos já estão organizados (pela análise documental e, se aplicável, pela Skill temática) e é preciso construir, comparar e consolidar o raciocínio jurídico de mérito — em Direito Privado, Público ou matéria híbrida.\n\n**Não use quando:** ainda não há base factual confiável; para redigir petição; para pesquisa jurisprudencial ampla (a Skill apenas sinaliza pontos que a recomendam).\n\n**Pré-requisito:** Relatório Documental Objetivo / Resumo Executivo e, quando pertinente, o Relatório Temático da Skill de matéria.\n\n**Entrada mínima:**\n```\n/tese-juridica\n\nRepresentamos: [PARTE].\nObjetivo material: [OBJETIVO]\nUtilize a análise documental anterior e os documentos originais.\n```" }
      ...
      "Viabilidade e proposta honorários": [{ title: "Proposta de Honorários", text: "**Aciona com:** `/proposta-honorarios`\n\n**Use quando:** já existe escopo de serviço suficientemente definido e é preciso apresentar condições comerciais ao cliente (pode ocorrer em qualquer momento após a análise do caso, não apenas ao final do fluxo).\n\n**Não use quando:** é preciso analisar viabilidade jurídica, elaborar parecer, redigir contrato de honorários definitivo ou produzir peça processual — nenhuma dessas tarefas é feita por esta Skill.\n\n**Pré-requisito:** definição mínima do serviço a ser prestado (mesmo que informal).\n\n**Entrada mínima:**\n```\n/proposta-honorarios\n\nCliente: [SE NÃO ESTIVER NO CONTEXTO]\nObjeto: [SE NÃO ESTIVER NO CONTEXTO]\n```\nA Skill pergunta obrigatoriamente o **modelo de honorários** (fixo, pró-labore + êxito, mensalidade, por etapa, ou combinação) e as **instâncias/fases incluídas**, caso ainda não estejam definidas — e não avança sem essas respostas.\n\n**Produz:** Proposta de Honorários Advocatícios pronta para envio ao cliente (objeto, escopo, limites do escopo, honorários, honorários de êxito se houver, despesas, validade, próximos passos). Não é contrato." }],
                  "Elaborar petição": [{ title: "Petição Inicial", text: "**Aciona com:** `/peticao-inicial casos/[CASO]/`\n\n**Use quando:** há tese consolidada, fatos comprovados e objetivo processual definidos, e o cliente já autorizou o ajuizamento de ação de conhecimento comum.\n\n**Não use quando:** o caso é de Mandado de Segurança, cumprimento de sentença/execução, ou quando ainda não há tese consolidada (a Skill não reconstrói estratégia).\n\n**Entrada mínima:**\n```\n/peticao-inicial\n\nContratação formalizada.\n\nRepresentamos: [NOME DA PARTE AUTORA].\n\nObjetivo processual:\n[INFORMAR O PROVIMENTO JURISDICIONAL PRETENDIDO].\n\nUtilize automaticamente a tese jurídica consolidada, os relatórios, resumos, documentos e demais informações deste caso já disponíveis no contexto.\n\nElabore a versão final completa da petição inicial conforme a Skill, preservando integralmente a estratégia jurídica previamente definida.\n\nSe houver informação realmente impeditiva ou questão bloqueante ainda não definida pelo advogado, não crie solução jurídica autônoma. Prossiga até onde for possível e indique o ponto no controle interno antes do protocolo.\n\nContexto adicional:\n[INCLUIR SOMENTE SE HOUVER ORIENTAÇÃO ESPECÍFICA PARA ESTE CASO].\n\n```\n\n**Produz:** petição inicial completa (Bloco A — texto para protocolo) + controle interno (Bloco B — documentos para instrução e pontos a confirmar antes do protocolo, quando houver pendência)." }, { title: "Mandado de Segurança", text: "**Aciona com:** `/mandado-de-seguranca casos/[CASO]/`\n\n**Use quando:** há ato administrativo, omissão de autoridade ou, excepcionalmente, ato judicial, e a via mandamental é potencialmente cabível (direito líquido e certo, prova pré-constituída).\n\n**Não use quando:** o caso pede petição inicial comum ou execução; ou quando os fatos dependem de dilação probatória incompatível com a via mandamental.\n\n**Entrada mínima:**\n```\n/mandado-de-seguranca\n\nContratação formalizada.\nImpetrante: [PARTE]\nObjetivo: [OBJETIVO]\nNatureza do ato: [ADMINISTRATIVO / OMISSÃO / JUDICIAL]\n```\nPara ato judicial, acrescentar: `Aplique o protocolo reforçado de excepcionalidade.`\n\n**Produz:** teste de admissibilidade completo e, se cabível, a peça (endereçamento, autoridade coatora, cabimento, decadência, fatos, direito líquido e certo, liminar, pedidos). Sinaliza lacuna impeditiva antes de redigir, se houver." }, { title: "Execução e Cumprimento", text: "**Aciona com:** `/execucao-e-cumprimento casos/[CASO]/`\n\n**Use quando:** o caso envolve cumprimento de sentença ou execução de título judicial/extrajudicial, para credor, devedor ou terceiro afetado — inclusive apenas para auditoria de título/cálculo, sem gerar peça.\n\n**Não use quando:** o caso pede petição inicial comum ou Mandado de Segurança.\n\n**Entrada mínima:**\n```\n/execucao-e-cumprimento\n\nRepresentamos: [EXEQUENTE / EXECUTADO]\nProcedimento: [cumprimento de sentença / execução de título extrajudicial]\nObjetivo: [OBJETIVO]\n```\nPara pedir apenas auditoria, sem peça: `Modo: auditoria de título e cálculo. Não elabore peça.`\n\n**Produz:** saída adaptável — auditoria do título, auditoria de cálculo, quadro de parâmetros, estratégia, manifestação, impugnação, embargos, exceção de pré-executividade ou peça completa, conforme solicitado." }],
                            };
