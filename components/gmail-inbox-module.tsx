  ...
  return (
    <div className="space-y-6">
      <div className="bg-white border-l-4 border-brand p-8 shadow-sm mb-6 rounded-sm">
        <h2 className="text-3xl font-serif text-brand-black tracking-tight">Correio Eletrônico Institucional</h2>
        <p className="text-brand-gray mt-2 font-medium">Gestão centralizada de comunicações, clientes e notificações judiciais.</p>
      </div>
